...
boolean privStop = true;    

            
boolean privEditPrice = true;

int SESS_LANGUAGE = 0;
String typeOfBusiness ="0";
String approot ="";
 %>
...
<%
    ...
    String departmentTitle = "Category";//
    int recordToGet = 15;
    String msgString = "";
...
<html><!-- #BeginTemplate "/Templates/main.dwt" --><!-- DW6 -->
    ...
    <style>
        ...
        <style type="text/css">
            <% int tableHeader = 0x0F0F0F;
                int tableCell = 0xFFFFE;
                %>
    ...
    <body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">    
        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" style="background: linear-gradient(to right, #9eb8d9, #C2F2D0);">
                                            ...
                                            <td height="22" valign="middle" colspan="3">
                                                ...
                                                <table width="17%" border="0" cellspacing="2" cellpadding="3">
                                                    <tr>
                                                        ...
                                                        <td nowrap width="82%"><a class="btn btn-info" href="javascript:cmdAdd()" class="command"><i class="fa fa-plus-circle"></i> <%=ctrLine.getCommand(SESS_LANGUAGE, departmentTitle, ctrLine.CMD_ADD, true)%></a></td>
                                                        <%}%>
                                                    </tr>
                                                    <tr>
                                                        <%if (source == 1) {%>
                                                        ...
                                                        <td nowrap width="82%"><a class="btn btn-info" href="javascript:cmdClose()" class="command"><i class="fa fa-close"></i> <%=ctrLine.getCommand(SESS_LANGUAGE, departmentTitle, ctrLine.CMD_BACK_SEARCH, true)%></a></td>
                                                        <%}%>
                                                    </tr>
                                                </table>
                                                <%}%>			
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <!--td nowrap width="80%" align="right"><a href="javascript:cmdExport()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Cari Barang"></a></td-->
                    <td class="command" nowrap width="80%"><a class="btn btn-info" href="javascript:cmdExport()"><i class="fa fa-file"></i> Export Excel</a></td>    
                </tr>
            </table>
        </td>
    </tr>
