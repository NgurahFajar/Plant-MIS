...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content">
    <div class="row mb-3">
        <div class="col-12 col-md-6 d-flex align-items-center">
            <h2 class="mb-2">Plant Detail Unit</h2>
        </div>
        <div class="col-12 col-md-6 text-end">
            <a href="add-plantunit.jsp" class="btn btn-success">Add New Unit</a>
        </div>
    </div>
        ...
        <table class="table table-bordered table-striped align-middle">
            ...
            <%
                ...
                try {
                    ...
                    ps = conn.prepareStatement("SELECT * FROM plant_detail_unit LIMIT ?, ?");
                    ps.setInt(1, start);
                    ...
                    <td>
                        <div class="d-flex flex-column align-items-center gap-2">
                            <button type="button" class="btn btn-sm"
                                ...
                                onclick="location.href='edit-plantunit.jsp?id=<%= rs.getInt("id") %>'">
            ...
            <%
                    ...
                    ps = conn.prepareStatement("SELECT COUNT(*) FROM plant_detail_unit");
                    rs = ps.executeQuery();
                    int totalRecords = 0;
                    if (rs.next()) {
        ...
        <ul class="pagination justify-content-center">
            ...
            %>
                <li class="page-item <%= (i == currentPage) ? "active" : "" %>">
                    <a class="page-link" href="detail-unit.jsp?page=<%= i %>"><%= i %></a>
                </li>
            <%
                }
            %>
        ...
        button.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'delete-plantunit.jsp?id=' + id;
                }
            });
        });
    });
